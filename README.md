...
Values resolve in one documented order:
...
- JSON config files plus registered YAML, TOML, or application formats
- Named-struct composition with collision-free flag and environment prefixes
...
- Fresh validated configuration snapshots for live reload
